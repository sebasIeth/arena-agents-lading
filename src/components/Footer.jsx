    ...
    <footer className="border-t border-warm-gray py-10">
      <div className="max-w-[1200px] mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center sm:items-end gap-3">
          <div className="bg-cream-dark rounded-lg px-3 py-1.5">
            <span className="text-[9px] font-semibold uppercase tracking-widest text-warm-mid mr-2">CA</span>
            <code className="text-xs font-mono text-ink break-all">4GQ1eYpTat1Tf1CjHG5nzWXLP5GV8GopQTqMEdbuMLux</code>
          </div>
          <div className="flex items-center gap-4">
          <a
